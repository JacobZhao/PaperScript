...
and applied power simulation. Before reconfiguration, it has two peaks in power generation, while, if we reconfigure connection among PV panels, it can generate more power. 
