...
Firstly, PV panel characteristics (current values, voltage values) are extracted and closed values are grouped.



\section{Feasibility Problem}\label{sec:feasibility-problem}
