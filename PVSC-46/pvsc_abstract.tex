...
Email:   \{zhao.dafang.yu7, f-oosita, kounoe\}@is.naist.jp}}
\maketitle
...
%PV panels are selected for each loss level. 
...
\begin{center}
\begin{tabular}{ccc}
%\multicolumn{3}{c}{\begin{tabular}[c]{@{}c@{}}COMPARISON BETWEEN EXISTED METHODS\\ AND PROPOSED ALGORITHM\end{tabular}}     
\hline \hline
