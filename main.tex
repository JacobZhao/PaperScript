...
\\In this paper, we using non-uniform irradiance levels to represent mismatch condition and analysis the efficiency of a PV system under different shaded working condition is presented.When photovoltaic arrays operating in non-uniform irradiance levels may present multiple local maxmimum power points (MPPs) \cite{b1}, which been genearated by turning on bypass diodes.
