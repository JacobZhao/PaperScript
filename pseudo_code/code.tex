...
\For{$p_{a_x}$ in \textup{\{TempConf\}}}
  ...
  \uElseIf{&$\sum_{x}^{x+2} M_{(j,\alpha_x)}$ $==$ 3 $==$ $M_{(j,\alpha_y)}$ \textup{\textbf{and}} $M_{(j,\alpha_x)}$ == $M_{(j,\alpha_{x+1})}$ == $M_{(j,\alpha_{x+2})}$, y $>$n}{
    TempConf =TempConf - \{$p_{\alpha_x}$, $p_{\alpha_{x+1}}$, $p_{\alpha_{x+2}}$\}+\{$p_{\alpha_y}$\} \;
  }
    \uElseIf{$\sum_{x}^{x+2} M_{(j,\alpha_x)}$ $==$ 3 $==$ $M_{(j,\alpha_y)}$ y $>$n}{
    TempConf =TempConf - \{$p_{\alpha_x}$, $p_{\alpha_{x+1}}$, $p_{\alpha_{x+2}}$\}+\{$p_{\alpha_y}$\} \;
  }
    \uElseIf{$\sum_{x}^{x+2} M_{(j,\alpha_x)}$ $==$ 2 $==$ $M_{(j,\alpha_y)}$ y $>$n}{
